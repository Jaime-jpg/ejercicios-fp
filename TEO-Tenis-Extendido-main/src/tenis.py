...
def fechas_ordenadas_por_jugador(partidos: list[PartidoTenis]):
...
def num_partidos_nombre(partidos: list[PartidoTenis]):
...
def superficie_con_mas_tenistas_distintos(partidos: list[PartidoTenis]):
...
def mas_errores_por_jugador(partidos: list[PartidoTenis]):
...
def n_partidos_mas_errores_por_jugador(partidos: list[PartidoTenis]):
...
def mayor_numero_dias_sin_jugar(partidos: list[PartidoTenis]):
